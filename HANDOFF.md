...
- EF Core migration `20260830020059_AddPlatformToTraderAndNotification` generated, hand-corrected (see gotcha #4 and the default-value bug below), and **applied to the local dev DB** (`telegram-bot/TelegramBot/fomofaster_ws.db`, a copy of the prod DB brought over to this machine, not the live prod DB itself).
